...
bool TicTacToe::isGameOver()
{
	...
	if (winner() > 0) return true; // if winner function returns 1 or 2, then theres a winner
...
//Goes through the rows, columns, and diagonals to check for three matches in a row based on player #
//that is stored in board array
...
void TicTacToe::play()
{
	...
	if (winner() > 0){ //checks if theres a winner, if there is output the player winner, if not, tie game
